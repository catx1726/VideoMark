    ...
    >
      ...
      >
        <svg
          ...
          class="w-[64px] h-[64px] text-neutral-300"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        <p class="text-[14px] text-neutral-400 mt-1 text-center max-w-[240px]">
          在任意网页观看视频时，按下
          <kbd class="px-1 py-0.5 rounded bg-neutral-100 dark:bg-neutral-700 font-mono text-xs border border-neutral-200 dark:border-neutral-600">Ctrl+Shift+L</kbd>
          即可标记当前时间点
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-xl p-5 w-80 max-w-full mx-4">
        ...
        <div class="space-y-2 max-h-60 overflow-y-auto">
          <label class="flex items-center gap-2 p-2 rounded hover:bg-neutral-100 dark:hover:bg-neutral-700 cursor-pointer">
            ...
            >
            <span class="text-sm text-neutral-700 dark:text-neutral-200">收集箱 (Inbox)</span>
          </label>
          <label
        ...
        <div class="flex justify-end mt-4">
          <button
            class="px-4 py-2 text-sm font-medium text-neutral-900 bg-amber-500 rounded-md hover:bg-amber-600"
