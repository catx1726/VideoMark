...
<template>
  <div
    class="fixed bottom-0 left-0 right-0 z-10 bg-white/80 dark:bg-neutral-800/80 border-t border-neutral-200 dark:border-neutral-700 backdrop-blur-sm transition-all duration-200 ease-in-out"
